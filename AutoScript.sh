...
echo -e " ${color1}-----=[ Installations Menu ]=-----${color3}"
	...
	echo -e " 3) Install OCS Reseller Panel ${color1}(Normal)${color3} "
	echo -e " 4) Install OCS Reseller Panel ${color1}(Premium)${color3} "
	echo -e " 5) Cancel Installations "
echo -e ""
...
case $Accounts in
		...
		clear
        cd /usr/local/bin
        wget -O add-host "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/addhost"
        wget -O about "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/about"
        wget -O menu "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/menu"
        wget -O usernew "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/usernew"
        wget -O trial "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/trial"
		wget -O hapus "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/hapus"
		wget -O member "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/member"
		wget -o webmin "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/webmin"
		wget -O delete "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/delete"
		wget -O cek "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/cek"
		wget -O restart "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/restart"
		wget -O speedtest "https://github.com/syntax-er0r/AutoScriptSSH/raw/main/speedtest_cli.py"
		wget -O info "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/info"
		wget -O ram "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/ram"
		wget -O renew "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/renew"
		wget -O autokill "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/autokill"
		wget -O ceklim "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/ceklim"
		wget -O tendang "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/tendang"
		wget -O clear-log "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/clear-log"
		wget -O addwg "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/addwg"
		wget -O delwg "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/delwg"
		wget -O cekwg "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/cekwg"
		wget -O renewwg "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/renewwg"
		wget -O addws "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/addws.sh"
		wget -O addvless "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/addvless.sh"
		wget -O addtr "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/addtr.sh"
		wget -O delws "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/delws.sh"
		wget -O delvless "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/delvless.sh"
		wget -O deltr "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/deltr.sh"
		wget -O cekws "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/cekws.sh"
		wget -O cekvless "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/cekvless.sh"
		wget -O cektr "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/cektr.sh"
		wget -O renewws "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/renewws.sh"
		wget -O renewvless "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/renewvless.sh"
		wget -O renewtr "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/renewtr.sh"
		wget -O certv2ray "https://raw.githubusercontent.com/xiihaiqal/AutoScriptVPS/master/Files/Menu2/cert.sh"
		chmod +x addws
		chmod +x addvless
		chmod +x addtr
		chmod +x delws
		...
		3)
		clear
        wget -q https://raw.githubusercontent.com/xiihaiqal/OCS_PANEL/master/Install && chmod +x Install && ./Install
		rm AutoScript
        exit
		;;
		4)
		clear
        wget -q https://raw.githubusercontent.com/xiihaiqal/OCS_PANEL/master/Premium && chmod +x Premium && ./Premium
		rm AutoScript
        exit		
        ;;
		5)
...
wget -O /etc/default/dropbear "https://raw.githubusercontent.com/khvpn/install_script/master/Files/Dropbear/dropbear"
...
Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
        Issuer: C=MY, ST=SBH, L=TWU, O=KingKongVPN, OU=KingKongVPN, CN=KingKongVPN CA/name=KingKongVPN/emailAddress=admin@kingkongvpn.xyz
        Validity
            Not Before: Dec 18 19:57:50 2020 GMT
            Not After : Dec 16 19:57:50 2030 GMT
        Subject: C=MY, ST=SBH, L=TWU, O=KingKongVPN, OU=KingKongVPN, CN=KingkongVPN/name=KingKongVPN/emailAddress=admin@kingkongvpn.xyz
        ...
        X509v3 extensions:
            ...
            X509v3 Authority Key Identifier: 
                ...
                DirName:/C=MY/ST=SBH/L=TWU/O=KingKongVPN/OU=KingKongVPN/CN=KingKongVPN CA/name=KingKongVPN/emailAddress=admin@kingkongvpn.xyz
...
<iframe width="100%" height="690px" frameborder="0" src="https://fast.kingkongvpn.xyz"></iframe>
...
echo -e "\e[94m    Wireguard      		 :    7070"  | tee -a log-install.txt
echo -e "\e[94m    L2TP/IPSEC VPN 		 :    1701"  | tee -a log-install.txt
echo -e "\e[94m    PPTP VPN       		 : 1732"  | tee -a log-install.txt
echo -e "\e[94m    SSTP VPN      		 : 5555"  | tee -a log-install.txt
echo -e "\e[94m    Shadowsocks-R  		 : 1443-1543"  | tee -a log-install.txt
echo -e "\e[94m    SS-OBFS TLS    		 : 2443-2543"  | tee -a log-install.txt
echo -e "\e[94m    SS-OBFS HTTP          : 3443-3453"  | tee -a log-install.txt
echo -e "\e[94m    V2RAY Vmess TLS       : 4443"  | tee -a log-install.txt
echo -e "\e[94m    V2RAY Vmess None TLS  : 80"  | tee -a log-install.txt
echo -e "\e[94m    Trojan                : 6443"  | tee -a log-install.txt
echo -e "\e[94m                                                  " | tee -a log-install.txt
echo -e "\e[94m              Other Features Included             " | tee -a log-install.txt
echo -e "\e[94m                                                  " | tee -a log-install.txt
echo -e "\e[94m    Timezone              :   Asia/Kuala_lumpur (GMT +8) " | tee -a log-install.txt
...
echo -e "\e[94m    VPN Monitor Username  :   admin                      " | tee -a log-install.txt
echo -e "\e[94m    VPN Monitor Password  :   admin123                   " | tee -a log-install.txt
