#!/bin/bash
	SERVER_PUB_IP=`ifconfig | grep -Eo 'inet (addr:)?([0-9]*\.){3}[0-9]*' | grep -Eo '([0-9]*\.){3}[0-9]*' | grep -v '127.0.0' | head -n1`
    SERVER_WG_NIC=wg0
	SERVER_WG_IPV4=`ifconfig | grep -Eo 'inet (addr:)?([0-9]*\.){3}[0-9]*' | grep -Eo '([0-9]*\.){3}[0-9]*' | grep -v '127.0.0' | head -n1`
	SERVER_WG_IPV6=fd42:42:42::1
	SERVER_WG_IPV5=10.66.66.1
	SERVER_PORT=2600
...
Address = 10.66.66.1/32,${CLIENT_WG_IPV6}/128
